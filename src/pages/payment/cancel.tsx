  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-10">
      <div className="max-w-lg w-full mx-4 bg-white rounded-2xl shadow-lg p-8 text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-4">Payment Cancelled</h2>
        <p className="text-gray-600 mt-2">
          Your {plan || ''} payment was cancelled. No amount was charged. You can retry the payment anytime.
        </p>
        {order_id && (
