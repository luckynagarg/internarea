...
import { Users as UsersIcon, Search, Trash2, X, AlertTriangle, MailCheck, Loader2 } from "lucide-react";
    ...
    <AdminLayout>
      ...
      {loading ? (
        <div className="bg-white rounded-lg shadow p-10 text-center text-gray-500">
          <Loader2 className="inline-block h-8 w-8 animate-spin text-blue-600 mb-2" />
          <p>Loading users...</p>
        </div>
      ) : error ? (
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {users.map((u) => (
                <tr key={u.uid} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{u.friendCount || 0}</td>
